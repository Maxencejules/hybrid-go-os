"""M34 acceptance: maturity bundle includes supply-chain continuity evidence."""
...
import verify_sbom_provenance_v2 as reval  # noqa: E402


def test_maturity_supply_chain_continuity_v1(tmp_path: Path):
    ...
    assert reval.main(["--sbom", str(sbom_out), "--provenance", str(prov_out), "--out", str(reval_out)]) == 0
