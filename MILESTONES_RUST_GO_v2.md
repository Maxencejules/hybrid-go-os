> **DEPRECATED** — This file is superseded by [MILESTONES.md](MILESTONES.md). Kept for historical reference.

# Hybrid OS Plan: Rust Kernel (low-level) + Go Services (high-level)
...
### Issues
- [ ] (p0) Limine boot image skeleton (ISO builder, limine.cfg)
